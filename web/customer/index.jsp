            ...
            <div id="menuPopupConShow" class="popup ui-widget-content"
                ...
                <div class="popup_main popbox_p_bg03">
                    ...
                    <div class="popup_product_detail">
                        ...
                        <input type="button" id="startOrderBtn" onclick="startOrder();" class="layerorder_btn">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="s_login" class="notmenu right s_rm_login"
            ...
            <div class="right_order">
                ...
                <div class="right_order_main">
                    <p class="username">
                        <input name="mobi" id="mobi" type="text" value="请输入手机号" class="input_text" maxlength="50">
                    </p>

                    <p class="Til" style="display:none"></p>
                    <div style="display: none" id="showPwd">
                        <p class="password" style="display: block;">
                    ...
                    <div id="showVerifyCode" class="showVerifyCode" style="display: none;">
                        <div class="validate_user_line">
                            <div class="validate_user_value">
                                <input id="verifyCode" class="validate_user_input validate_user_smscode"
                                       value="请输入验证码">
                                <div class="validate_btn">
                                    <img src="getRandVerifyCode.action" id="verifyCodeImg"
                                         style="float: right;padding-left: 5px;">
                                </div>
                                <div class="validate_btn" id="sendVerifyCodeBtn"
                                     style="margin-left: 0px;width: 70px;margin-top: -23px;">更新验证码
                                </div>
                            </div>
                        </div>
                    </div>
